...
label lion_dialogue:
    menu:
        ...
        "(Deception) Get on your knees and pretend to be afraid of Nike" if intimidate_deceive:
            ...
            sys "Your guardian angel may give you an advantage if you actually seem scared, or a disadvantage if it seems obviously fake."
            sys "DC: [deception_dc]"
            menu:
...
label lion_climax:
    ...
    menu:
        "Try to scare the lions away by roaring at them! (Intimidation dc: [intimidate_dc])":
            ...
            sys "Your guardian angel may give you an advantage if you seem particularly scary, or a disadvantage if you are not at all scary."
            menu:
                "Success >=[intimidate_dc]":
