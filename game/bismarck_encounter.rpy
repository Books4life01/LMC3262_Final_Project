...
label atlas_trial:
    ...
    menu:
        ...
        "Guardian Angel: The player gave up.":
            stop sound
...
label slingshot:
    ...
    "Guardian Angel: Did the player collect a stick and a pebble for the slingshot?"
    menu:
        "Yes":
...
label sword:
    ...
    "Your guardian angel should know the way and guide you. Best of luck!"
    return